...
<head>
    ...
    <link rel="stylesheet" href="{{ url('public/vendor') }}/datatables/css/jquery.dataTables.min.css">
    <link rel="stylesheet" href="{{ url('public/vendor') }}/jquery-nice-select/css/nice-select.css">
